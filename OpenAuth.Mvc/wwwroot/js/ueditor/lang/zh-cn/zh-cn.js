...
UE.I18N['zh-cn'] = {
    'labelMap':{
        ...
        'fontfamily':'字型', 'fontsize':'字號', 'paragraph':'段落格式', 'simpleupload':'單圖上傳', 'insertimage':'多圖上傳','edittable':'表格屬性','edittd':'單元格屬性', 'link':'超鏈接',
        ...
        'rowspacingtop':'段前距', 'rowspacingbottom':'段后距',  'pagebreak':'分頁', 'insertframe':'插入Iframe', 'imagenone':'預設',
    ...
    'insertimage':{
        'static':{
            ...
            'searchType':{'title':"圖片型別", 'options':["新聞", "壁紙", "表情", "頭像"]}, //select的option
    ...
    'link':{
        ...
        'validLink':'只支援選中一個鏈接時生效',
        'httpPrompt':'您輸入的超鏈接中不包含http等協議名稱，預設將為您新增http://字首'
    },
    'map':{
        'static':{
            lang_city:"城市",
    ...
    'searchreplace':{
        'static':{
            ...
            lang_search2:"查詢",
            lang_replace:"替換",
            lang_searchReg:'支援正規表示式，新增前後斜槓標示為正規表示式，例如「/表達式/」',
            lang_searchReg1:'支援正規表示式，新增前後斜槓標示為正規表示式，例如「/表達式/」',
    ...
    'snapscreen':{
        'static':{
            ...
            lang_step2:"第二步，外掛安裝完成後即可使用，如不生效，請重啟瀏覽器后再試！"
        }
    },
    'spechars':{
        'static':{},
    ...
    'wordimage':{
        'static':{
            ...
            lang_step:"1、點選頂部複製按鈕，將地址複製到剪貼簿；2、點選新增照片按鈕，在彈出的對話方塊中使用Ctrl+V貼上地址；3、點選打開后選擇圖片上傳流程。"
        },
        'fileType':"圖片",
