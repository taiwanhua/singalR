...
(function () {
    ...
    scrawl.prototype = {
        ...
        initOptions:function (options) {
            ...
            me._buildToolbarColor(options.colorList);//動態產生顏色選擇集合

            me._addBoardListener(options.saveNum);//新增畫板處理
            me._addOPerateListener(options.saveNum);//新增undo redo clearBoard處理
            me._addColorBarListener();//新增顏色選擇處理
            me._addBrushBarListener();//新增畫筆大小處理
            me._addEraserBarListener();//新增橡皮大小處理
            me._addAddImgListener();//新增增添背景圖片處理
            me._addRemoveImgListenter();//刪除背景圖片處理
            me._addScalePicListenter();//新增縮放處理
            me._addClearSelectionListenter();//新增清楚選中狀態處理
