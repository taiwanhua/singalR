...
namespace OpenAuth.App.Flow
{
    public class FlowRuntime
    {
        ...
        /// 獲取實例接下來執行的狀態
        /// </summary>
        /// <returns>-1無法執行,0會簽開始,1會簽結束,2一般節點,4流程執行結束</returns>
        ...
        /// <summary>
        /// 獲取節點型別 0會簽開始,1會簽結束,2一般節點,開始節點,4流程執行結束
        /// </summary>
        ...
        /// 駁回
        /// </summary>
        /// <param name="rejectType">駁回型別。null:使用節點配置的駁回型別/0:前一步/1:第一步/2：指定節點，使用NodeRejectStep</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 當前節點型別 0會簽開始,1會簽結束,2一般節點,開始節點,4流程執行結束
        /// </summary>
        ...
        /// <summary>
        /// 下一個節點型別 -1無法執行,0會簽開始,1會簽結束,2一般節點,4流程執行結束
        /// </summary>
